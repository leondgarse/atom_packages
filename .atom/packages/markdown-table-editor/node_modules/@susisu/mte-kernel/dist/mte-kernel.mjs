...
export { Alignment, DefaultAlignment, Delete, Focus, FormatType, HeaderAlignment, ITextEditor, Insert, Point, Range, Table, TableCell, TableEditor, TableRow, alterAlignment, applyEditScript, completeTable, deleteColumn, deleteRow, formatTable, insertColumn, insertRow, moveColumn, moveRow, options, readTable, shortestEditScript };
